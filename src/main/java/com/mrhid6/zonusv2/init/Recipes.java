...
public class Recipes {
	...
	public static void init() {
		...
		// TODO
		// GameRegistry.addSmelting(ModBlocks.ZoriteOre, ModItems.zoroIngot,
		// 0.5f);

		GameRegistry.addSmelting(new ItemStack(ModBlocks.zonusOres, 1, 0),
				new ItemStack(ModItems.zoroIngot), 0.5F);

		GameRegistry.addRecipe(new ItemStack(ModBlocks.machineBlock), "is",
				"si", 's', new ItemStack(Blocks.stone), 'i', new ItemStack(
						ModItems.zoroIngot));
		GameRegistry
				.addRecipe(new ItemStack(ModBlocks.zoroFurnace), "sis", "mfm",
						"sms", 's', new ItemStack(Blocks.stone), 'm',
						new ItemStack(ModBlocks.machineBlock), 'f',
						new ItemStack(Blocks.furnace), 'i', new ItemStack(
								ModItems.zoroIngot));
	...
	public static class ZoroFurnaceRecipes {
		...
		public static void init() {
			recipes.add(new ZoroFurnaceRecpie(new ItemStack(Items.iron_ingot),
					new ItemStack(ModItems.zoroIngot)));
		}
