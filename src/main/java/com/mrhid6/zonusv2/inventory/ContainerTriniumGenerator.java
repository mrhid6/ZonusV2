...
public class ContainerTriniumGenerator extends ContainerZonus {
	...
	public ContainerTriniumGenerator(InventoryPlayer inventoryPlayer,
			TileEntityTriniumGenerator tileEntityTrinGen) {

		this.tileEntityTrinGen = tileEntityTrinGen;

		addSlotToContainer(new Slot(tileEntityTrinGen,
				TileEntityTriniumGenerator.INPUT_INVENTORY_INDEX, 56, 24));
	...
	public void addCraftingToCrafters(ICrafting iCrafting) {
		...
		iCrafting.sendProgressBarUpdate(this, 0,
				this.tileEntityTrinGen.getStoredPower());
		iCrafting.sendProgressBarUpdate(this, 1,
				this.tileEntityTrinGen.getDeviceCookTime());
		iCrafting.sendProgressBarUpdate(this, 2,
				this.tileEntityTrinGen.getTotalFuelTime());
	}
	...
	public void detectAndSendChanges() {
		...
		for (Object crafter : this.crafters) {
			...
			if (this.lastDeviceCookTime != this.tileEntityTrinGen
					.getDeviceCookTime()) {
				icrafting.sendProgressBarUpdate(this, 1,
						this.tileEntityTrinGen.getDeviceCookTime());
			}

			if (this.lastTotalFuelBurn != this.tileEntityTrinGen
					.getTotalFuelTime()) {
				icrafting.sendProgressBarUpdate(this, 2,
						this.tileEntityTrinGen.getTotalFuelTime());
			}
