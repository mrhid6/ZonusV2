...
public class PacketHandler
{
    ...
    public static void init()
    {
        ...
        INSTANCE.registerMessage(MessageTileEntityZoroFurnace.class, MessageTileEntityZoroFurnace.class, 1, Side.CLIENT);
        INSTANCE.registerMessage(MessageTileEntityCableBase.class, MessageTileEntityCableBase.class, 2, Side.CLIENT);
        INSTANCE.registerMessage(MessageTileEntityTriniumGenerator.class, MessageTileEntityTriniumGenerator.class, 3, Side.CLIENT);
    }
}
