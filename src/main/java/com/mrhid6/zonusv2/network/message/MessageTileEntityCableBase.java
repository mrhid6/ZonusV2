...
public class MessageTileEntityCableBase implements IMessage,
		IMessageHandler<MessageTileEntityCableBase, IMessage> {
	public int x, y, z;
	public int power;
	...
	public MessageTileEntityCableBase(TileEntityCableBase tileEntityCableBase,
			boolean[] connections) {
		this.x = tileEntityCableBase.xCoord;
		this.y = tileEntityCableBase.yCoord;
		this.z = tileEntityCableBase.zCoord;
		this.power = tileEntityCableBase.getStoredPowerBuffer();
	...
	@Override
	public IMessage onMessage(MessageTileEntityCableBase message,
			MessageContext ctx) {
		...
		if (tileEntity instanceof TileEntityCableBase) {
			...
			cable.setStoredPowerBuffer(message.power);
