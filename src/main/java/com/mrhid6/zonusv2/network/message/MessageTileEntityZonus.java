...
public class MessageTileEntityZonus implements IMessage, IMessageHandler<MessageTileEntityZonus, IMessage>
{
    public int x, y, z;
    ...
    {
        return String.format("MessageTileEntityZonus - x:%s, y:%s, z:%s, orientation:%s, state:%s, customName:%s, owner:%s", x, y, z, orientation, state, customName, owner);
    }
}
