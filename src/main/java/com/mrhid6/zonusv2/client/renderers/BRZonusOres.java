...
public class BRZonusOres extends BRZonus{
	...
	public void renderInventoryBlock(Block block, int metadata, int modelID, RenderBlocks renderer) {
		...
		if(light != null){
			...
			renderer.renderFaceYNeg(block, 0.0D, 0.0D, 0.0D, light.getIcons()[0]);
			tessellator.draw();
			tessellator.startDrawingQuads();
			tessellator.setNormal(0.0F, 1.0F, 0.0F);
			tessellator.setColorOpaque_F( 1.0f, 1.0f, 1.0f );
			tessellator.setBrightness( 14 << 20 | 14 << 4 );
			renderer.renderFaceYPos(block, 0.0D, 0.0D, 0.0D, light.getIcons()[0]);
			tessellator.draw();
			tessellator.startDrawingQuads();
			tessellator.setNormal(0.0F, 0.0F, -1.0F);
			tessellator.setColorOpaque_F( 1.0f, 1.0f, 1.0f );
			tessellator.setBrightness( 14 << 20 | 14 << 4 );
			renderer.renderFaceZNeg(block, 0.0D, 0.0D, 0.0D, light.getIcons()[0]);
			tessellator.draw();
			tessellator.startDrawingQuads();
			tessellator.setNormal(0.0F, 0.0F, 1.0F);
			tessellator.setColorOpaque_F( 1.0f, 1.0f, 1.0f );
			tessellator.setBrightness( 14 << 20 | 14 << 4 );
			renderer.renderFaceZPos(block, 0.0D, 0.0D, 0.0D, light.getIcons()[0]);
			tessellator.draw();
			tessellator.startDrawingQuads();
			tessellator.setNormal(-1.0F, 0.0F, 0.0F);
			tessellator.setColorOpaque_F( 1.0f, 1.0f, 1.0f );
			tessellator.setBrightness( 14 << 20 | 14 << 4 );
			renderer.renderFaceXNeg(block, 0.0D, 0.0D, 0.0D, light.getIcons()[0]);
			tessellator.draw();
			tessellator.startDrawingQuads();
			tessellator.setNormal(1.0F, 0.0F, 0.0F);
			tessellator.setColorOpaque_F( 1.0f, 1.0f, 1.0f );
			tessellator.setBrightness( 14 << 20 | 14 << 4 );
			renderer.renderFaceXPos(block, 0.0D, 0.0D, 0.0D, light.getIcons()[0]);
			tessellator.draw();
			GL11.glTranslatef(0.5F, 0.5F, 0.5F);
		}
	}
