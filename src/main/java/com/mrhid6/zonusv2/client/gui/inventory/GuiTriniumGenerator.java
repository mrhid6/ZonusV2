...
public class GuiTriniumGenerator extends GuiZonus{
	...
	public GuiTriniumGenerator(InventoryPlayer inventoryPlayer, TileEntityTriniumGenerator tileEntityTrinGen) {
	...
	protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
		...
		if (l > 0) {
			...
			drawTexturedModalRect(x + 56, y + 42 +12 - l, 176, 12 - l, 16, l +2 );
		}
	}
	...
	protected void drawTooltips() {
		...
		if (isHovering(42, 144, 61, 71)) {
			drawToolTip(tileEntityTrinGen.getStoredPower() + "z " + "/ " + tileEntityTrinGen.getMaxPower() + "z");
		}
