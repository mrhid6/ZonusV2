...
public class RenderZoroFurnace extends BaseBlockRender {
	...
	public void renderTileEntityAt(TileEntity tileEntity, double x, double y,
		...
		if (tileEntity != null && tileEntity instanceof TileEntityZoroFurnace) {
			...
			try {
				renderBlocks.renderBlockByRenderType(ModBlocks.zoroFurnace,
						(int) x, (int) y, (int) z);
				...
				renderBlocks = new RenderBlocks(
						tileEntityZoroFurnace.getWorldObj());
			}

			renderTileEntityZoroFurnace(tileEntityZoroFurnace,
					tileEntity.getWorldObj(), (int) x, (int) y, (int) z);

		}
	}

	public void renderTileEntityZoroFurnace(
			TileEntityZoroFurnace tileEntityZoroFurnace, World world, int x,
			int y, int z) {
	...
	private void scaleTranslateRotate(double x, double y, double z,
